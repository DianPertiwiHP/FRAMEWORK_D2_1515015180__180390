...
<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container">
				...
				<button type="button" class="navbar-toggle collapse" data-toggle="collapse" data-target="#navbar" aria-expended="false" aria-controls="navbar">
					...
					<ul class="nav navbar-nav">
						<li class="dropdown active">
							...
							<ul class="dropdown-menu" aria-labelledby="dLabel">
								...
								<li class="dropdown active">
									<a href="#" data-toggle="dropdown" role="button" aria-hapopup="true" aria-expended="false"> Pengaturan <span class="caret"></span> </a>
										<ul class="dropdown-menu" aria-labelledby="dLabel">
